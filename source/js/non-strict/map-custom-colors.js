...
(function() {
  ...
  apiKey.src = 'https://maps.googleapis.com/maps/api/js?key=' + (apiKeyEncodedParts[4] + apiKeyEncodedParts[1] + apiKeyEncodedParts[0] + apiKeyEncodedParts[3] + apiKeyEncodedParts[2]) + '&callback=initMap';
